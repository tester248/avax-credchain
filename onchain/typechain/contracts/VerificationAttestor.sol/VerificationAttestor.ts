...
export interface VerificationAttestorInterface extends utils.Interface {
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "VERIFIER_ROLE()": FunctionFragment;
    "attestations(bytes32)": FunctionFragment;
    "createAttestation(address,bytes32,uint8,string)": FunctionFragment;
  ...
  events: {
    "AttestationCreated(bytes32,address,uint8,address)": EventFragment;
...
export interface VerificationAttestor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VerificationAttestorInterface;
  ...
  functions: {
    ...
    createAttestation(
      ...
      attHash: PromiseOrValue<BytesLike>,
  ...
  filters: {
    "AttestationCreated(bytes32,address,uint8,address)"(
